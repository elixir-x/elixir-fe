...
const onKeyUp = () => {
	...
	if (usernameError.value !== undefined || username.value === undefined)
		return;
	...
	<form class="form">
		<div class="fields field-wrapper">
			...
			<Input
				...
				label="Username"
				:error-class="
					usernameError?.includes('available') ? 'success' : 'error'
				"
				@keyup="onKeyUp" />
			<Input
				name="password"
		...
		<span class="mt-4 text-center text-sm text-neutral-300">
